...
const Chatt = () => {
  ...
  //     convo.participants?.filter((participant) => participant !== userId)
  //   ) || [];
  // console.log("otherParticipants", otherParticipants);
  // console.log("jsut a random under otherParticipants");
  ...
  //     router.push({
  //       pathname: "/messages",
  //       params: { owner: JSON.stringify(recepient) },
  //     });
  //   }
  // }, [recepient, router]);
  ...
  // console.log("Last Messages", lastMessages);
  // console.log("RecepientId click", recepientId);

  // useEffect(() => {
  //   if (recepientId) {
  //     getRecepientUser((data) => {
  //       setRecepient(data);
  //       if (data?._id) {
  //         router.push({
  //           pathname: `/messages`,
  ...
  // useEffect(() => {
  //   console.log("useffect router.push");
  //   router.push({
  //     pathname: `/messages`,
  //     params: { owner: JSON.stringify(recepientUser) },
  //   });
